...
| CodeMirror 5.65.16 | `web/vendor/cm5/` | MIT | [licenses/MIT-CodeMirror5.txt](licenses/MIT-CodeMirror5.txt) |
...
> **关于 CodeMirror**：`web/vendor/cm5/*.min.js` 是 jsDelivr 用 Terser 压缩的产物，
