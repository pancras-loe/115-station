...
// ==================== 按需离线（边下边播）播放端点 ====================
//
// STRM 内容不再直接关联网盘文件，而是指向 115-Station 自己的播放端点：
//
//	ed2k://|file|某剧集.S01E01.1080p.mkv|123456789|hash…
//	    ↓ 入库时（离线提交成功后自动登记）
//	/media/按需离线/某剧集.S01E01.1080p.mkv.strm → http://115-Station:6086/ed2k/play/<id>
//	    ↓ Emby 播放时请求这个 URL
//	115-Station: 查任务状态 → 没下过就提交 115 离线下载 → 短暂轮询
//	    ↓ 完成（本次等到，或之后的某次播放）
//	302 跳转 115 直链 → 播放器开播
//
